...
import com.lincook.backend.Entity.RefreshToken;
import com.lincook.backend.Repository.MemberRepository;
import com.lincook.backend.Repository.RefreshTokenRepository;
import com.lincook.backend.controller.dto.MemberRequestDto;
import com.lincook.backend.controller.dto.MemberResponseDto;
import com.lincook.backend.controller.dto.TokenDto;
import com.lincook.backend.controller.dto.TokenRequestDto;
...
public class AuthService {
    ...
    public TokenDto login(MemberRequestDto memberRequestDto)
    {
        ...
        // authenticate 메서드가 실행이 될 때 CunstomUserDetailsService에서 만들었던 loadUserByUsername메서드가 실행됨
    ...
    public TokenDto reissue(TokenRequestDto tokenRequestDto)
    {
        ...
        {
            throw new RuntimeException("토큰의 유저 정봐 일치하지 않습니다.");
        }
